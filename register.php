...
<head>
    ...
    <meta name="description" content="Create your free Travelit account and start booking premium Indian travel packages.">
    <title>Travelit — Create Account</title>
...
<div class="auth-card">
    ...
    <div class="brand">
        ...
        <div class="brand-sub">Join thousands of explorers across India</div>
    </div>
    ...
    <form id="registerForm">
        ...
        <div class="mb-3">
            ...
            <small style="color:#555; font-size:0.78rem; margin-top:4px; display:block;">Minimum 6 characters</small>
        </div>

        <button type="submit" class="btn-auth">Create Account</button>
    </form>

    <div id="registerMsg" class="text-center mt-3 small"></div>
...
$("#registerForm").submit(function(e) {
    ...
    $.ajax({
        ...
        success: function(response) {
            if(response === "success") {
                $("#registerMsg").html("<span class='text-success'><i class='fa fa-check-circle'></i> Account created! Redirecting to login...</span>");
                setTimeout(function() {
        ...
        error: function() {
            $("#registerMsg").html("<span class='text-danger'>Something went wrong. Please try again.</span>");
            btn.html("Create Account").prop("disabled", false);
        }
    });
});
